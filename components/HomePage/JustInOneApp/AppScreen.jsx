...
const AppScreen = (props) => {
  ...
  const altTags = [ 'Grafterr Go! - Sell anything, anywhere.',
  ...
  return (
    ...
    <div className='justOneAppScreen h-full w-full relative lg:overflow-hidden'>
        <Image className='xl:-right-20 appScreenImage' src={currentActive} alt={`${currentActiveAlt}`} objectFit="contain" layout="fill" />
    </div>
  )
}
