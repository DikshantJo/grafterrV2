...
import checkmark from "../../public/grafterrImage/contactUsSvg/checkmark.svg";
import sucessMessageIconI from "../../public/grafterrImage/contactUsSvg/sucessMessageIconI.svg";
import successMessageIconII from "../../public/grafterrImage/contactUsSvg/successMessageIconII.svg";
  ...
  return (
    ...
    >
      ...
      <div
        className={
          success
            ? "flex flex-col absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[400px]  h-[100px] sm:h-[150px] justify-center items-center rounded-md bg-white z-40"
            : "hidden"
        }
          ...
          <div className="toast__cell">
            <div className="toast toast--green">
              ...
              <div className="toast__close">
                <Image src={successMessageIconII}></Image>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="contactUsSubContainer flex flex-col items-center justify-center md:w-3/5  lg:w-3/5  xl:w-1/2 h-3/4">
        <div className="contactUsTitle flex flex-col justify-center items-center mb-7 sm:mb-14">
          <h3 className="contactUsTitle text-center">We are here to help</h3>
          <span className="contactUsCaption text-center">
